...
const popupProfileInputName = popupProfile.querySelector('.form__input-text_value_name');
const popupProfileInputJob = popupProfile.querySelector('.form__input-text_value_job');
...
const popupAddCardInputCardName = popupAddCard.querySelector('.form__input-text_value_card-name');
const popupAddCardInputLinkPhoto = popupAddCard.querySelector('.form__input-text_value_link-photo');
